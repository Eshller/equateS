    ...
    >
      ...
      <div className="">
        <motion.div
          ...
          className="absolute h-[115vh] w-[100vw] overflow-hidden"
          // initial={{ x: '0%' }}
          // animate={{ x: '100%' }}
        ...
        >
          <div className="relative h-full w-full aspect-[2/1]">
            <div className="relative h-full w-full ">
              <div className="h-full w-full relative flex items-center justify-center">
                {/* <h1 className="text-[4vh] sm:text-[6vh] md:text-[10vh] lg:text-[12vh] xl:text-[14vh] text-white font-thin">TECHNOLOGY</h1> */}
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <ParallaxBanner
            className="relative h-full w-full aspect-[2/1]"
            layers={[
              {
                speed: 30,
                scaleY: [1, 2.4],
                ...
                children: (
                  <div className="relative h-full w-full ">
                    <div className="h-full w-full relative flex items-center justify-center">
                      <h1 className="text-[4vh] sm:text-[6vh] md:text-[10vh] lg:text-[12vh] xl:text-[14vh] text-white font-thin">
                        TECHNOLOGY
                      </h1>
                    </div>
                  </div>
        ...
        <div
          className="overflow-hidden absolute top-[400vh] left-[0vw] w-[100vw] h-[633.6vh]"
          style={{
        ...
        >
          <div className="z-50 transition ease-in-out">
            <Parallax
              className="w-[15vw] rotate-12 relative md:top-[-66vh] top-[-99vh] left-[78vw] lg:top-[-34vh] xl:top-[-38vh]"
              scaleY={[1.4, 2.1]}
              scaleX={[1.4, 2.3]}
            >
              <img
            ...
            <Parallax
              className="w-[10vw] rotate-3 relative md:top-[-49vh] top-[-73vh] left-[10vw] lg:top-[-24vh] xl:top-[-25vh]"
              scaleY={[1.4, 2.1]}
              scaleX={[1.4, 2.3]}
            >
              <img
            ...
            <Parallax
              className="w-[12vw] relative md:top-[-4vh] top-[-25vh] left-[80vw] lg:top-[16vh] xl:top-[13vh]"
              scaleY={[1.4, 2.1]}
              scaleX={[1.4, 2.3]}
            >
              <img
