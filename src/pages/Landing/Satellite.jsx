...
const Satellite = () => {
  return (
    ...
    >
      ...
      <div className="h-0">
        <div className="absolute top-[100vh] left-[0vh]  md:top-[120vh]  md:left-[13vw] lg:left-[30vw] md:w-[70vh] md:h-[70vh] w-[90vw] h-[90vh] items-center justify-center flex z-0 ">
              <div
                className="absolute top-[10vh] md:top-0 h-[56vh] w-[86vw] sm:h-[80vh] sm:w-[86vw] md:w-[100vh] md:h-[110vh] md:left-[-10vw] lg:left-[-7vw]"
                style={{
